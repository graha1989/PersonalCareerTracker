var app = angular.module('PersonalCareerTracker',['ngRoute', 'ui.bootstrap'])
	.config(['$routeProvider', '$httpProvider', function($routeProvider, $httpProvider){
      ...
      .when('/facultyOrUniversityAuthoritiesWork/professorId/:professorId', {
        templateUrl: 'pages/facultyOrUniversityAuthoritiesWork.html?professorId=:professorId',
        controller: 'FacultyOrUniversityAuthoritiesWorkController'
      })
      .when('/facultyOrUniversityAuthoritiesWork', {
        templateUrl: 'pages/facultyOrUniversityAuthoritiesWork.html',
        controller: 'FacultyOrUniversityAuthoritiesWorkController'
      })
      .when('/professionalOrganizationConduction/professorId/:professorId', {
        templateUrl: 'pages/professionalOrganizationConduction.html?professorId=:professorId',
        controller: 'ProfessionalOrganizationConductingController'
      })
      .when('/professionalOrganizationConduction', {
      ...
      .when('/meetingsConferencesAndEventsConduction/professorId/:professorId', {
        templateUrl: 'pages/meetingsConferencesAndEventsConduction.html?professorId=:professorId',
        controller: 'MeetingsConferencesAndEventsConductingController'
      })
      .when('/meetingsConferencesAndEventsConduction', {
        templateUrl: 'pages/meetingsConferencesAndEventsConduction.html',
        controller: 'MeetingsConferencesAndEventsConductingController'
      })
      .when('/scientificJournalReviews/professorId/:professorId', {
        templateUrl: 'pages/scientificJournalReviews.html?professorId=:professorId',
        controller: 'ScientificJournalReviewsController'
      })
      .when('/scientificJournalReviews', {
