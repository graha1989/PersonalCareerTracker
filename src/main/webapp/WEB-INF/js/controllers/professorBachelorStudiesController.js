app.controller("ProfessorBachelorStudiesController", function($scope, $routeParams, $http, $route, $location, $modal, PctService) {
  ...
  $scope.studyPrograms = [{
    ...
    'studyAreas': [{
      'name': "Biologija",
      'title': "Diplomirani biolog"
    }, {
      'name': "Ekologija",
      'title': "Diplomirani ekolog"
    }]
  }, {
    'name': "Hemija, biohemija i zaštita životne sredine",
    'studyAreas': [{
      'name': "Hemija",
      'title': "Diplomirani hemičar"
    }, {
      'name': "Biohemija",
      'title': "Diplomirani biohemičar"
    }, {
      'name': "Zaštita životne sredine",
      'title': "Diplomirani inženjer zaštite životne sredine"
    }]
  }, {
    'name': "Geografija, turizam i hotelijerstvo",
    'studyAreas': [{
      'name': "Geografija",
      'title': "Diplomirani geograf"
    }, {
      'name': "Turizam",
      'title': "Diplomirani turizmolog"
    }, {
      'name': "Hotelijerstvo",
      'title': "Diplomirani hotelijer"
    }]
  }];
  ...
  $scope.init = function() {
    $scope.initUserId();
    $scope.loadProfessorsBachelorStudies($scope.professorId, $routeParams.thesisTypeId);
...
var createNewBachelorStudiesController = function($scope, $modalInstance, $routeParams, $http, $route, $templateCache, PctService, professorId) {
  ...
  $scope.validateForm = function() {
    if ((($scope.bachelorStudies.facultyName != null && $scope.bachelorStudies.facultyName != '') || ($scope.selectedFaculty != null && $scope.selectedFaculty != ''))
            ...
            && $scope.bachelorStudies.thesisTitle != '' && $scope.bachelorStudies.acquiredTitle != null && $scope.bachelorStudies.acquiredTitle != '') {
      return true;
    } else {
      return false;
    }
