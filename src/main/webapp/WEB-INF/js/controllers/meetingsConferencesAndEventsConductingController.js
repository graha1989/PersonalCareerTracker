app.controller("MeetingsConferencesAndEventsConductingController", function($scope, $routeParams, $http, $route,
  ...
  $scope.editConduction = function(id) {
    $modal.open({
      templateUrl: 'editMeetingsConferencesAndEventsConductionPopup.html',
      controller: editMeetingsConferencesAndEventsConductionController,
      resolve: {
  ...
  $scope.createNewConduction = function() {
    $modal.open({
      templateUrl: 'createNewMeetingsConferencesAndEventsConductionPopup.html',
      controller: createNewMeetingsConferencesAndEventsConductionController,
      resolve: {
        professorId: function() {
          return $scope.professorId;
        }
