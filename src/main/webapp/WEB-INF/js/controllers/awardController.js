app.controller("AwardController", function($scope, $routeParams, $http, $route, $modal, PctService) {
...
var editAwardController = function($scope, $modalInstance, $routeParams, $http, $route, awardId, PctService) {
  ...
  $scope.isUnchanged = function(award) {
    ...
    return angular.isUndefined(award.awardType) || angular.isUndefined(award.awardField)
...
var createNewAwardController = function($scope, $modalInstance, $routeParams, $http, $route, PctService, professorId) {
