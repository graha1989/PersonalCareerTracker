app.controller("BachelorMentoringController", function($scope, $routeParams, $http, $location, $modal, PctService) {
...
var editBachelorThesisController = function($scope, $modalInstance, $routeParams, $http, $route, thesisId, PctService, mentorId) {
...
var createNewBachelorThesisController = function($scope, $modalInstance, $routeParams, $http, $route, PctService, mentorId) {
