		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li>
						<a href="" ng-click="openProfessorAwards()">{{ resources.professorMenuLabels.awards }}</a>
					</li>
					<li>
					...
					<li class="dropdown"><a href="" class="dropdown-toggle"
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="" ng-click="openInternationalPublications()">{{ resources.professorMenuLabels.publicationTypes.internationalPublications }}</a></li>
						</ul>
					</li>
					<li>
						<a href="" ng-click="openProfessorWorkExperiences()">{{ resources.professorMenuLabels.workExperiences }}</a>
					</li>
					<li>
						<a href="" ng-click="openProfessorTeachingExperiences()">{{ resources.professorMenuLabels.teachingExperiences }}</a>
					</li>
					<li>
						<a href="" ng-click="openProfessorProjectExperiences()">{{ resources.professorMenuLabels.projectExperiences }}</a>
					</li>
				</ul>
			</div>
		</div>
