...
public class KorisnikFormaDTO implements Serializable {
	...
	public KorisnikFormaDTO() {
		super();
	}

	public KorisnikFormaDTO(String userName, String password, String email, Uloga uloga, Boolean isProfessor,
