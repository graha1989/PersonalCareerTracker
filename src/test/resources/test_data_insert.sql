...
INSERT INTO project (name, financedBy, projectStartDate, projectEndDate, projectType, projectLeader) VALUES
	...
	ON DUPLICATE KEY UPDATE name=VALUES(name), financedBy=VALUES(financedBy), projectStartDate=VALUES(projectStartDate), projectEndDate=VALUES(projectEndDate), projectType=VALUES(projectType), projectLeader=VALUES(projectLeader);
	
INSERT INTO project_experience (projectId, professorId, professorLeader) VALUES
	('1', '3', '0'),
	('2', '3', '0')
	ON DUPLICATE KEY UPDATE projectId=VALUES(projectId), professorId=VALUES(professorId), professorLeader=VALUES(professorLeader);
...
INSERT INTO studies (professorId, institutionId, studiesThesisTypeId, studyProgram, studyArea, studyStartDate, studyEndDate, averageGrade, thesisTitle, acquiredTitle, specialisticStudiesStayPurpose, specialisticStudiesAbroadStartDate, specialisticStudiesAbroadEndDate, specialisticStudiesAbroadCity, specialisticStudiesAbroadCountry) VALUES
	('3', '1', '1', 'MATHEMATICS_AND_INFORMATICS', 'Informatika', '2012-04-14 00:00:00', '2014-08-04 00:00:00', '9.50', 'Bachelor teza', 'asistent pripravnik', null, null, null, null, null),
	('3', '3', '2', 'MATHEMATICS_AND_INFORMATICS', 'Informatika', '2012-04-14 00:00:00', '2014-08-04 00:00:00', '9.88', 'Master teza 1', 'asistent', null, null, null, null, null),
	('3', '3', '3', 'MATHEMATICS_AND_INFORMATICS', 'Informatika', '2012-04-14 00:00:00', '2014-08-04 00:00:00', '9.88', 'Specialistička teza 1', 'asistent', null, null, null, null, null),
	('3', '3', '4', 'MATHEMATICS_AND_INFORMATICS', 'Informatika', '2012-04-14 00:00:00', '2014-08-04 00:00:00', '9.88', 'Doktorska teza 1', 'asistent', null, null, null, null, null)
	ON DUPLICATE KEY UPDATE professorId=VALUES(professorId), institutionId=VALUES(institutionId), studiesThesisTypeId=VALUES(studiesThesisTypeId), studyProgram=VALUES(studyProgram), studyArea=VALUES(studyArea), studyStartDate=VALUES(studyStartDate), studyEndDate=VALUES(studyEndDate), averageGrade=VALUES(averageGrade), thesisTitle=VALUES(thesisTitle), acquiredTitle=VALUES(acquiredTitle), specialisticStudiesStayPurpose=VALUES(specialisticStudiesStayPurpose), specialisticStudiesAbroadStartDate=VALUES(specialisticStudiesAbroadStartDate), specialisticStudiesAbroadEndDate=VALUES(specialisticStudiesAbroadEndDate), specialisticStudiesAbroadCity=VALUES(specialisticStudiesAbroadCity), specialisticStudiesAbroadCountry=VALUES(specialisticStudiesAbroadCountry);